...
export class cancelOrderQueue extends  WorkerHost{
    constructor(private readonly databaseService: DatabaseService,
        @InjectQueue('cancelOrderCampaign') private readonly cancelOrderCampaign: Queue,
    ) {
        super();
    }
  ...
  try {
          ...
          console.log('Received cancel order data:', orderData);
          console.log('cancel order in processor');
          const contact =
